...
const Crew = (0, import_index_e3bd9a9f.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div id="${"crew"}" class="${"svelte-16uz5gc"}"><div class="${"content-container"}"><div class="${"header"}">${(0, import_index_e3bd9a9f.v)(import_PageHeader_6296cf40.P, "PageHeader").$$render($$result, { stepNumber: "02", step: "Meet Your Crew" }, {}, {})}</div></div>
</div>`;
});
